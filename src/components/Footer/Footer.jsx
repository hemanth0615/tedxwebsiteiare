...
function Footer() {
  return (
    <>
      <footer>
        <div className='grid grid-cols-1 w-full h-54  pt-10 lg:px-24 xl:grid-cols-3 lg:gap-y-6 lg:grid-cols-2 lg:h-80 md:grid-cols-2 md:h-96'>
      ...
      <section className='mobile-footer'>
        <div className='grid grid-cols-2 px-0  sm:-space-x-52 -space-x-44 m-g mobile-f-s-1 t-g'>
          ...
          <div className='mt-3 m-i'>
            ...
            <p className='font-medium sm:text-lg leading-6 text-[#fff] tracking-widest w-full overflow-hidden mt-3 m-i-i'>Organised by curious individuals from the local community, TEDxAmsterdam features live speakers who seek to spark</p>
